...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.widget = QtGui.QWidget(self.large_drop_area_frame)
        self.widget.setObjectName("widget")
        self.label_3 = QtGui.QLabel(self.widget)
        self.label_3.setGeometry(QtCore.QRect(0, 470, 56, 12))
        self.label_3.setObjectName("label_3")
        self.layoutWidget = QtGui.QWidget(self.widget)
        self.layoutWidget.setGeometry(QtCore.QRect(1, 41, 691, 31))
        self.layoutWidget.setObjectName("layoutWidget")
        self.horizontalLayout_8 = QtGui.QHBoxLayout(self.layoutWidget)
        self.horizontalLayout_8.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_8.setObjectName("horizontalLayout_8")
        self.check_button = QtGui.QPushButton(self.layoutWidget)
        self.check_button.setMaximumSize(QtCore.QSize(70, 40))
        self.check_button.setObjectName("check_button")
        self.horizontalLayout_8.addWidget(self.check_button)
        self.uncheck_button = QtGui.QPushButton(self.layoutWidget)
        self.uncheck_button.setMaximumSize(QtCore.QSize(80, 40))
        self.uncheck_button.setObjectName("uncheck_button")
        self.horizontalLayout_8.addWidget(self.uncheck_button)
        ...
        self.listView.setGeometry(QtCore.QRect(0, 80, 691, 381))
        self.listView.setObjectName("listView")
        self.layoutWidget_2 = QtGui.QWidget(self.widget)
        self.layoutWidget_2.setGeometry(QtCore.QRect(0, 490, 691, 37))
        self.layoutWidget_2.setObjectName("layoutWidget_2")
        self.horizontalLayout_9 = QtGui.QHBoxLayout(self.layoutWidget_2)
        self.horizontalLayout_9.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_9.setObjectName("horizontalLayout_9")
        self.excel_open_button = QtGui.QPushButton(self.layoutWidget_2)
        ...
        self.horizontalLayout_9.addWidget(self.excel_open_button)
        self.excel_save_button = QtGui.QPushButton(self.layoutWidget_2)
        ...
        self.horizontalLayout_9.addWidget(self.excel_save_button)
        spacerItem1 = QtGui.QSpacerItem(550, 30, QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Minimum)
        self.horizontalLayout_9.addItem(spacerItem1)
        self.publish_button = QtGui.QPushButton(self.widget)
        self.publish_button.setGeometry(QtCore.QRect(0, 530, 691, 31))
        self.publish_button.setObjectName("publish_button")
        self.layoutWidget_3 = QtGui.QWidget(self.widget)
        self.layoutWidget_3.setGeometry(QtCore.QRect(0, 0, 691, 25))
        ...
        self.browse_button = QtGui.QPushButton(self.layoutWidget_3)
        self.browse_button.setText("")
        self.browse_button.setObjectName("browse_button")
        self.horizontalLayout_10.addWidget(self.browse_button)
        self.copy_button = QtGui.QPushButton(self.layoutWidget_3)
        self.copy_button.setText("")
        self.copy_button.setObjectName("copy_button")
        self.horizontalLayout_10.addWidget(self.copy_button)
        self.scan_button = QtGui.QPushButton(self.layoutWidget_3)
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Flow Production Tracking Publish"))
        Dialog.setAccessibleName(_translate("Dialog", "publish dialog"))
        self.main_stack.setAccessibleName(_translate("Dialog", "stackedwidget"))
        self.label_3.setText(_translate("Dialog", "Excel"))
        self.check_button.setText(_translate("Dialog", "check_all"))
        self.uncheck_button.setText(_translate("Dialog", "uncheck_all"))
        self.label_4.setText(_translate("Dialog", "Colorspace"))
        self.comboBox.setItemText(0, _translate("Dialog", "ACES - ACES2065-1"))
        self.excel_open_button.setText(_translate("Dialog", "Open"))
        self.excel_save_button.setText(_translate("Dialog", "Save"))
        self.publish_button.setText(_translate("Dialog", "Publish"))
        self.label.setText(_translate("Dialog", "SCAN PATH :"))
        self.main_ui_frame.setAccessibleName(
            QtGui.QApplication.translate("Dialog", "Main publish frame", None, QtGui.QApplication.UnicodeUTF8))
        self.main_frame.setAccessibleName(
            QtGui.QApplication.translate("Dialog", "Upper frame", None, QtGui.QApplication.UnicodeUTF8))
        self.splitter.setAccessibleName(
            QtGui.QApplication.translate("Dialog", "splitter", None, QtGui.QApplication.UnicodeUTF8))
        self.frame.setAccessibleName(
            QtGui.QApplication.translate("Dialog", "tree frame", None, QtGui.QApplication.UnicodeUTF8))
        self.items_tree.setAccessibleName(
            QtGui.QApplication.translate("Dialog", "collected items tree", None, QtGui.QApplication.UnicodeUTF8))
        self.text_below_item_tree.setText(
            QtGui.QApplication.translate("Dialog", "Drag and drop items here to add them. ", None,
                                         QtGui.QApplication.UnicodeUTF8))
        self.details_frame.setAccessibleName(
            QtGui.QApplication.translate("Dialog", "details frame", None, QtGui.QApplication.UnicodeUTF8))
        self.details_stack.setAccessibleName(
            QtGui.QApplication.translate("Dialog", "details stacked widget", None, QtGui.QApplication.UnicodeUTF8))
        self.details_item.setAccessibleName(
            QtGui.QApplication.translate("Dialog", "item details", None, QtGui.QApplication.UnicodeUTF8))
        self.item_icon.setAccessibleName(
            QtGui.QApplication.translate("Dialog", "item icon", None, QtGui.QApplication.UnicodeUTF8))
        self.item_name.setText(
            QtGui.QApplication.translate("Dialog", "Item name", None, QtGui.QApplication.UnicodeUTF8))
        self.item_type.setText(
            QtGui.QApplication.translate("Dialog", "Item type", None, QtGui.QApplication.UnicodeUTF8))
        self.item_divider_1.setAccessibleName(
            QtGui.QApplication.translate("Dialog", "divider", None, QtGui.QApplication.UnicodeUTF8))
        self.context_widget.setAccessibleName(
            QtGui.QApplication.translate("Dialog", "context picker widget", None, QtGui.QApplication.UnicodeUTF8))
        self.item_inherited_item_label.setText(QtGui.QApplication.translate("Dialog",
                                                                            "<html><head/><body><p><span style=\" font-size:10pt;\">Inherited from: test</span></p></body></html>",
                                                                            None, QtGui.QApplication.UnicodeUTF8))
        self.item_thumbnail_label.setText(
            QtGui.QApplication.translate("Dialog", "Thumbnail:", None, QtGui.QApplication.UnicodeUTF8))
        self.item_thumbnail.setToolTip(
            QtGui.QApplication.translate("Dialog", "Click to take a screenshot.", None, QtGui.QApplication.UnicodeUTF8))
        self.item_thumbnail.setAccessibleName(
            QtGui.QApplication.translate("Dialog", "item thumbnail", None, QtGui.QApplication.UnicodeUTF8))
        self.item_description_label.setText(
            QtGui.QApplication.translate("Dialog", "Description:", None, QtGui.QApplication.UnicodeUTF8))
        self.item_comments.setAccessibleName(
            QtGui.QApplication.translate("Dialog", "item description", None, QtGui.QApplication.UnicodeUTF8))
        self.item_summary_label.setText(
            QtGui.QApplication.translate("Dialog", "Summary:", None, QtGui.QApplication.UnicodeUTF8))
        self.scrollArea.setAccessibleName(
            QtGui.QApplication.translate("Dialog", "summary scroll area", None, QtGui.QApplication.UnicodeUTF8))
        self.scrollAreaWidgetContents.setAccessibleName(
            QtGui.QApplication.translate("Dialog", "summary contents holder", None, QtGui.QApplication.UnicodeUTF8))
        self.expander_label.setAccessibleName(
            QtGui.QApplication.translate("Dialog", "expander label", None, QtGui.QApplication.UnicodeUTF8))
        self.item_settings_label.setText(
            QtGui.QApplication.translate("Dialog", "Settings:", None, QtGui.QApplication.UnicodeUTF8))
        self.item_settings.setAccessibleName(
            QtGui.QApplication.translate("Dialog", "item settings", None, QtGui.QApplication.UnicodeUTF8))
        self.details_task.setAccessibleName(
            QtGui.QApplication.translate("Dialog", "task details", None, QtGui.QApplication.UnicodeUTF8))
        self.task_icon.setAccessibleName(
            QtGui.QApplication.translate("Dialog", "task icon", None, QtGui.QApplication.UnicodeUTF8))
        self.task_name.setText(
            QtGui.QApplication.translate("Dialog", "Task Name", None, QtGui.QApplication.UnicodeUTF8))
        self.task_settings_scroll_area.setAccessibleName(
            QtGui.QApplication.translate("Dialog", "task settings scroll area", None, QtGui.QApplication.UnicodeUTF8))
        self.task_settings_parent.setAccessibleName(
            QtGui.QApplication.translate("Dialog", "task settings parent", None, QtGui.QApplication.UnicodeUTF8))
        self.task_settings.setAccessibleName(
            QtGui.QApplication.translate("Dialog", "task settings", None, QtGui.QApplication.UnicodeUTF8))
        self.details_please_select.setAccessibleName(
            QtGui.QApplication.translate("Dialog", "unselected details", None, QtGui.QApplication.UnicodeUTF8))
        self.please_select_an_item.setText(
            QtGui.QApplication.translate("Dialog", "Please select tasks of the same type or a single item.", None,
                                         QtGui.QApplication.UnicodeUTF8))
        self.details_multi_edit_not_supported.setAccessibleName(
            QtGui.QApplication.translate("Dialog", "non multi edit details", None, QtGui.QApplication.UnicodeUTF8))
        self.label_2.setText(
            QtGui.QApplication.translate("Dialog", "Multiple selection not supported on tasks of this type.\n"
                                                   "Please select a single task.", None,
                                         QtGui.QApplication.UnicodeUTF8))
        self.bottom_frame.setAccessibleName(
            QtGui.QApplication.translate("Dialog", "Bottom frame", None, QtGui.QApplication.UnicodeUTF8))
        self.button_container.setAccessibleName(
            QtGui.QApplication.translate("Dialog", "button container", None, QtGui.QApplication.UnicodeUTF8))
        self.browse.setToolTip(QtGui.QApplication.translate("Dialog",
                                                            "<p>Click this button to browse files for publishing. You can also click and hold the button to show the full browsing menu which includes an option to browse folders to publish image sequences.</p>",
                                                            None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.delete_items.setToolTip(
            QtGui.QApplication.translate("Dialog", "Delete selected items", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.expand_all.setToolTip(
            QtGui.QApplication.translate("Dialog", "Expand all items", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.collapse_all.setToolTip(
            QtGui.QApplication.translate("Dialog", "Collapse all items", None, QtGui.QApplication.UnicodeUTF8))
        self.collapse_all.setText(QtGui.QApplication.translate("Dialog", "...", None, QtGui.QApplication.UnicodeUTF8))
        self.help.setToolTip(QtGui.QApplication.translate("Dialog",
                                                          "<html><head/><body><p>Open documentation for the publish workflow.</p></body></html>",
                                                          None, QtGui.QApplication.UnicodeUTF8))
        self.help.setText(QtGui.QApplication.translate("Dialog", "...", None, QtGui.QApplication.UnicodeUTF8))
        self.progress_message.setText(
            QtGui.QApplication.translate("Dialog", "Progress message....", None, QtGui.QApplication.UnicodeUTF8))
        self.stop_processing.setToolTip(
            QtGui.QApplication.translate("Dialog", "Stop Processing", None, QtGui.QApplication.UnicodeUTF8))
        self.stop_processing.setText(
            QtGui.QApplication.translate("Dialog", "...", None, QtGui.QApplication.UnicodeUTF8))
...
from ..qtwidgets import ContextWidget, ElidedLabel
