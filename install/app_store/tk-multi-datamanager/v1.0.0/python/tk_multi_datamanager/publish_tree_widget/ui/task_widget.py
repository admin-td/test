...
class Ui_TaskWidget(object):
    def setupUi(self, TaskWidget):
        ...
        self.icon.setPixmap(QtGui.QPixmap(":/tk_multi_datamanagere/shotgun.png"))
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/tk_multi_datamanager/status_publish.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
