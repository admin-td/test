...
class Ui_ItemWidget(object):
    def setupUi(self, ItemWidget):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/tk_multi_datamanager/down_arrow.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.drag_handle.setPixmap(QtGui.QPixmap(":/tk_multi_datamanager/drag_handle.png"))
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/tk_multi_datamanager/status_validate.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
