...
UI_PYTHON_PATH=../python/tk_multi_datamanager/ui
build_ui dialog
...
UI_PYTHON_PATH=../python/tk_multi_datamanager/publish_tree_widget/ui
...
UI_PYTHON_PATH=../python/tk_multi_datamanager/progress/ui
