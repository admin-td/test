...
UI_PYTHON_PATH=../python/tk_multi_inhouse/ui
build_ui dialog
...
UI_PYTHON_PATH=../python/tk_multi_inhouse/publish_tree_widget/ui
...
UI_PYTHON_PATH=../python/tk_multi_inhouse/progress/ui
