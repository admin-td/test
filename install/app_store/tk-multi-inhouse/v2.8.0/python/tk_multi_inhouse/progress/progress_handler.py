...
class ProgressHandler(object):
    ...
    def __init__(self, icon_label, status_label, progress_bar):
        ...
        self._icon_lookup = {
            self.PHASE_LOAD: QtGui.QPixmap(":/tk_multi_inhouse/status_load.png"),
            self.PHASE_VALIDATE: QtGui.QPixmap(
                ":/tk_multi_inhouse/status_validate.png"
            ),
            self.PHASE_PUBLISH: QtGui.QPixmap(":/tk_multi_inhouse/status_publish.png"),
            self.PHASE_FINALIZE: QtGui.QPixmap(
                ":/tk_multi_inhouse/status_success.png"
            ),
        }

        self._icon_warning = QtGui.QPixmap(":/tk_multi_inhouse/status_warning.png")
        self._icon_error = QtGui.QPixmap(":/tk_multi_inhouse/status_error.png")
