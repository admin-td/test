...
class CustomTreeWidgetBase(QtGui.QFrame):
    ...
    def __init__(self, tree_node, parent=None):
        ...
        self._icon_lookup = {
            self.NEUTRAL: None,
            self.VALIDATION: QtGui.QPixmap(":/tk_multi_inhouse/status_validate.png"),
            self.VALIDATION_ERROR: QtGui.QPixmap(
                ":/tk_multi_inhouse/status_warning.png"
            ),
            self.PUBLISH: QtGui.QPixmap(":/tk_multi_inhouse/status_publish.png"),
            self.PUBLISH_ERROR: QtGui.QPixmap(":/tk_multi_inhouse/status_error.png"),
            self.FINALIZE: QtGui.QPixmap(":/tk_multi_inhouse/status_success.png"),
            self.FINALIZE_ERROR: QtGui.QPixmap(":/tk_multi_inhouse/status_error.png"),
            self.VALIDATION_STANDALONE: QtGui.QPixmap(
                ":/tk_multi_inhouse/status_success.png"
            ),
        }
