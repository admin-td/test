...
class SummaryOverlay(QtGui.QWidget):
    ...
    def show_no_items_error(self):
        ...
        """
        self.ui.icon.setPixmap(QtGui.QPixmap(":/tk_multi_inhouse/publish_failed.png"))
    ...
    def show_success(self):
        ...
        self.ui.icon.setPixmap(
            QtGui.QPixmap(":/tk_multi_inhouse/publish_complete.png")
        )
    ...
    def show_loading(self):
        ...
        """
        self.ui.icon.setPixmap(QtGui.QPixmap(":/tk_multi_inhouse/overlay_loading.png"))
