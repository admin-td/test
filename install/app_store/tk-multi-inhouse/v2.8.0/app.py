...
class MultiPublish2(sgtk.platform.Application):
    ...
    def init_app(self):
        ...
        tk_multi_publish2 = self.import_module("tk_multi_inhouse")
    ...
    def create_publish_manager(self, publish_logger=None):
        """
        Create and return a :class:`tk_multi_inhouse.PublishManager` instance.
        See the :class:`tk_multi_inhouse.PublishManager` docs for details on
        ...
        :returns: A :class:`tk_multi_inhouse.PublishManager` instance
        """
