...
"}")
        ...
        self.time_label = QtGui.QLabel(FileSaveForm)
        ...
        self.file_controls_grid.addWidget(self.time_label, 2, 0, 1, 1)
        ...
        self.file_controls_grid.addWidget(self.file_type_label, 3, 0, 1, 1)
        ...
        self.file_controls_grid.addLayout(self.horizontalLayout_6, 3, 1, 1, 1)
        ...
        self.time_edit = QtGui.QLineEdit(FileSaveForm)
        self.time_edit.setMaximumSize(QtCore.QSize(70, 16777215))
        self.time_edit.setFrame(True)
        ...
        self.file_controls_grid.addLayout(self.horizontalLayout_9, 2, 1, 1, 1)
        ...
        FileSaveForm.setTabOrder(self.use_next_available_cb, self.time_edit)
        FileSaveForm.setTabOrder(self.time_edit, self.file_type_menu)
    ...
    def retranslateUi(self, FileSaveForm):
        ...
        self.time_label.setText(QtGui.QApplication.translate("FileSaveForm", "<html><head/><body><p><span style=\" font-weight:600;\">Working time:</span></p></body></html>",None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.time_edit.setAccessibleName(QtGui.QApplication.translate("FileSaveForm", "Time Edit", None, QtGui.QApplication.UnicodeUTF8))
